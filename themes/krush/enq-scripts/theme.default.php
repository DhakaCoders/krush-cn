...
wp_enqueue_script('cbv-pr0', get_template_directory_uri() . '/assets/js/prslider0.js', array('jquery'), '1.0.0', true);
wp_enqueue_script('cbv-pr', get_template_directory_uri() . '/assets/js/prslider.js', array('jquery'), '1.0.0', true);
wp_enqueue_script('cbv-header', get_template_directory_uri() . '/assets/js/header.js', array('jquery'), '1.0.0', true);
