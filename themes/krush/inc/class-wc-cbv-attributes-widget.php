 ...
 */
class cbv_wc_attribute_widget extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'woocommerce_layered_attribute_nav';
		$this->widget_name        = __( 'CBV Filter Products by Attribute', 'woocommerce' );
		parent::__construct();
	}
	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type ) {
		...
		if ( is_shop() OR is_product_taxonomy() ) {
...
function cbv_wc_attribute_load_widget() {
    register_widget( 'cbv_wc_attribute_widget' );
}
add_action( 'widgets_init', 'cbv_wc_attribute_load_widget' );