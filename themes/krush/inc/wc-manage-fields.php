...
//add_action( 'woocommerce_account_content', 'zk_validation_billing_address' );
...
add_action('init', function() {
	add_rewrite_endpoint('cbv-orders', EP_ROOT | EP_PAGES);
});

add_action('woocommerce_account_cbv-orders_endpoint', function() {
	$order_id = get_query_var('cbv-orders');
